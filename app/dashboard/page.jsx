...
const Dashboard = () => {
    ...
    return (
        <main className="grow">
            ...
            <section className="flex w-[100%] mx-auto items-center justify-center p-4">
                <div className="shadow-2xl overflow-hidden flex-[1.5] hover:flex-[3] duration-200 m-1 rounded-md relative">
                    <Image
